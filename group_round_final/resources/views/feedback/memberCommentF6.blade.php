...
<body>
    <!-- 頁首 -->
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-white bg-body shadow-sm rounded mb-lg-5">
            <div class="container-fluid">
                <button type="button" class="btn">
                    <a class="navbar-brand" href="./header.php">
                        <img src="../img/logo-text-1.png" type="image/gif" width="120px">
                    </a>
                </button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        ...
                        <button class="btn btn-secondary btn-sm" type="submit">
                            <img src="../img/search.svg" type="image/gif" size="16x16">
                        </button>
                    </form>
                    <!-- 登入註冊 -->
                    <a class="nav-link link-dark" href="">
                        <img src="../img/log-in.svg" type="image/gif" size="16x16">
                        登入/註冊
                    </a>
                </div>
            </div>
